    ...
    public partial class AddEducationTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignedEducation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssignedEducation_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssignedEducation_Education_EducationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignedEducation_AppUserId",
                table: "AssignedEducation",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AssignedEducation_EducationId",
                table: "AssignedEducation",
                column: "EducationId");
